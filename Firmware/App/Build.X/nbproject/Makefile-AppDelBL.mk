...
ifeq "$(wildcard nbproject/Makefile-local-AppDelBL.mk)" "nbproject/Makefile-local-AppDelBL.mk"
include nbproject/Makefile-local-AppDelBL.mk
endif
endif
...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
Device=PIC16F18313
ProjectDir="C:\Users\acer\Desktop\_GitConDev\Firmware\App\ConDevApp.X"
ConfName=AppDelBL
ImagePath="dist\AppDelBL\${IMAGE_TYPE}\ConDevApp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\AppDelBL\${IMAGE_TYPE}"
ImageName="ConDevApp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-AppDelBL.mk dist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1360906485/os.p1: ../Src/os.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --rom=0-7DD --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -UBOOTLOADABLE -P -N255 -I"../../FwCom" --warn=-3 --asmlist -DXPRJ_AppDelBL=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xFF --codeoffset=0 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1360906485/os.p1  ../Src/os.c 
...
${OBJECTDIR}/_ext/1360906485/os.p1: ../Src/os.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360906485/os.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1360906485/os.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=24 --float=24 --rom=0-7DD --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -UBOOTLOADABLE -P -N255 -I"../../FwCom" --warn=-3 --asmlist -DXPRJ_AppDelBL=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xFF --codeoffset=0 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1360906485/os.p1  ../Src/os.c 
	@-${MV} ${OBJECTDIR}/_ext/1360906485/os.d ${OBJECTDIR}/_ext/1360906485/os.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1360906485/os.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --rom=0-7DD --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -UBOOTLOADABLE -P -N255 -I"../../FwCom" --warn=-3 --asmlist -DXPRJ_AppDelBL=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xFF --codeoffset=0 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.map  --double=24 --float=24 --rom=0-7DD --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -UBOOTLOADABLE -P -N255 -I"../../FwCom" --warn=-3 --asmlist -DXPRJ_AppDelBL=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xFF --codeoffset=0 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/ConDevApp.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
endif

.pre:
	@echo "--------------------------------------"
	@echo "User defined pre-build step: [.\..\..\Tools\prebuid.bat .\..\..\Tools\ReplaceAdd.py .\..\FwBootloader\Build\dist\default\production\Build.production.map .\..\App\Src\driver.h]"
	@.\..\..\Tools\prebuid.bat .\..\..\Tools\ReplaceAdd.py .\..\FwBootloader\Build\dist\default\production\Build.production.map .\..\App\Src\driver.h
	@echo "--------------------------------------"
