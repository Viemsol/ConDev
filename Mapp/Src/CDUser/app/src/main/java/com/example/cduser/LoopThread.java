...
import static com.example.cduser.GLOBAL_CONSTANTS.BLE_UART_FLASH;
import static com.example.cduser.GLOBAL_CONSTANTS.BLE_UART_FUCTION_SET_GPIO;
import static com.example.cduser.GLOBAL_CONSTANTS.BLE_UART_PING_APP;
import static com.example.cduser.GLOBAL_CONSTANTS.BLUETOOTH_BONDING_PASS;
...
import static com.example.cduser.GLOBAL_CONSTANTS.BLUETOOTH_FLASH_FAIL;
...
import static com.example.cduser.GLOBAL_CONSTANTS.CMD_BLUETOOTH_DEV_PING;
...
import static com.example.cduser.GLOBAL_CONSTANTS.DEVICE_COMMISION;
import static com.example.cduser.GLOBAL_CONSTANTS.DEVICE_OTA;
import static com.example.cduser.GLOBAL_CONSTANTS.DEVICE_PAIR_CONNECT;
import static com.example.cduser.GLOBAL_CONSTANTS.DEVICE_SEND_DATA;
import static com.example.cduser.GLOBAL_CONSTANTS.DEVICE_SEND_RCV_DATA;

import static com.example.cduser.GLOBAL_CONSTANTS.EVENT_TIMER;
import static com.example.cduser.GLOBAL_CONSTANTS.MAX_CMD_RESP_LEN_APP;
...
import static com.example.cduser.GLOBAL_CONSTANTS.TIMEOUT_BLUETOOTH_CONNECT_PAIR;
import static com.example.cduser.GLOBAL_CONSTANTS.TIMEOUT_COMMISON_FRAME;
import static com.example.cduser.GLOBAL_CONSTANTS.TIMEOUT_FLSHING_FRAME;
import static com.example.cduser.GLOBAL_CONSTANTS.TIMER_ONESHOT;
import static com.example.cduser.GLOBAL_CONSTANTS.TIMER_PAIR_TIMEOUT;
...
public class LoopThread extends Thread {
    ...
    public void Handle_Message(Message msg)
    {
        ...
        switch(msg.what)
        {
            ...
            case CMD_BLUETOOTH_DIV_DISCOVERY_5SEC:
                APP_SendCmdToMainUI(CMD_SET_PROGRESS_PERCENT,0);
           ...
           break;
            ...
            case BLUETOOTH_BONDING_PASS: // send commision command
                ...
                byte CmdPing[] = new byte[]{BLE_UART_PING_APP,0x00,0x00,0x00,0x00};
                ...
                {
                    byte[] Dev_Name_db = (((BleLibCmd) msg.obj).Dev_IDName).getBytes();
                    // update device ID
                    CmdCredCommision[7] = Dev_Name_db[2];
                    CmdCredCommision[8] = Dev_Name_db[3];
                    CmdCredCommision[9] = Dev_Name_db[4];
                    CmdCredCommision[10] = Dev_Name_db[5];
                }
                ...
                if(bleLib.Ble_CheckIfBondingSuces(Temp_BleDev))
                {
                    ...
                    switch (Temp_OriginalCmd)
                    {
                        ...
                        case CMD_BLUETOOTH_CONNECT_COMMISION:
                            CmdCredCommision[15] = CRC_Chk(CmdCredCommision, MAX_CMD_RESP_LEN_APP, 1);
                            ...
                            if ((tmp_status == RX_CMD_SUCESS) && (1 == CRC_Chk(RespCredCommision, MAX_CMD_RESP_LEN_APP, 0)))
                            {
                                ...
                                switch (Temp_OriginalCmd)
                                {
                                    ...
                                    case CMD_BLUETOOTH_DEV_CRED:
                                        ...
                                        if( (RespCredCommision[0] == BLE_UART_COMMISION) &&  (RespCredCommision[12] ==  BLE_UART_FUCTION_SET_GPIO) )
                                        {
                                    ...
                                    case CMD_BLUETOOTH_CONNECT_COMMISION:
                                        ...
                                        if (RespCredCommision[0] == BLE_UART_COMMISION)
                                        {
                                            ...
                                            DeviceDb DeviceDb_temp = new DeviceDb(Dev_ID, Dev_Typ, Dev_Rand, Dev_Mac, Mast_Id, Dev_Name, Dev_Img, User_Cred, Is_Master,Dev_Version,"");
                                    ...
                                    case CMD_BLUETOOTH_GET_VERSION:
                                        ...
                                        DeviceDb DeviceDb_temp = new DeviceDb(Dev_ID, 0, 0, "", 0, "", "", "", true,Dev_Version,"");
                                        msg.obj = DeviceDb_temp;
    ...
    byte CRC_Chk(byte data[], int len , int cmd_crc_calc)
    {
        len = len -1;
        byte st=0;
        int sum = 0,i=0;
